...
<html>
	...
	<body>
		...
		<table class="borderAll">
		    ...
		    <s:iterator value="languageDesigners" status="status"><!-- etiqueta de struts, vamos a  la clase de la acción y cogemos languageDesigners (la lista)-->
		...
		<s:actionerror />
		<s:actionmessage />
		<s:form action="languageDesigners!selectDesigner.action" method="post">
